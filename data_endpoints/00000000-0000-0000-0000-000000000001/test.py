"""
Test file for data endpoint: local-data-endpoint
Endpoint ID: 00000000-0000-0000-0000-000000000001

Run locally:
    python -m pytest data_endpoints/00000000-0000-0000-0000-000000000001/test.py -v
"""
import sys
import os
...
def test_local_data_endpoint_runs():
    code = _load_code()
    config = {
